...
$coming_soon = function_exists( 'wescarhealth_get' ) ? WescarHealth_Content_Helpers::get_coming_soon() : array();
...
<div class="coming-soon">
	<div class="coming-soon__container">
		...
		<div class="coming-soon__content">
			...
			<!-- Badge -->
			<span class="coming-soon__badge"><?php echo esc_html( $coming_soon['badge'] ?? __( 'Coming Soon', 'wescarhealth' ) ); ?></span>

			<!-- Title -->
			<h1 class="coming-soon__title">
				<?php echo esc_html( $coming_soon['title_1'] ?? __( 'Something', 'wescarhealth' ) ); ?> <em><?php echo esc_html( $coming_soon['title_em'] ?? __( 'Amazing', 'wescarhealth' ) ); ?></em> <?php echo esc_html( $coming_soon['title_2'] ?? __( 'Is On The Way', 'wescarhealth' ) ); ?>
			</h1>

			<!-- Description -->
			<p class="coming-soon__description">
				<?php echo esc_html( $coming_soon['description'] ?? __( 'We\'re working hard to bring you expert telehealth services. Stay tuned for surgical clearance, hormone therapy, urgent care, and preventive health — all from the comfort of your home.', 'wescarhealth' ) ); ?>
			</p>
			...
			<div class="coming-soon__social">
				<a href="<?php echo esc_url( $socials['facebook'] ?? 'https://facebook.com' ); ?>" class="coming-soon__social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
					<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
				</a>
				<a href="<?php echo esc_url( $socials['instagram'] ?? 'https://instagram.com' ); ?>" class="coming-soon__social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
				...
				<a href="<?php echo esc_url( $socials['linkedin'] ?? 'https://linkedin.com' ); ?>" class="coming-soon__social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
